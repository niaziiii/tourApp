...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"modules/alertMsg.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.alertMsg = void 0;

var alertMsg = function alertMsg(status, msg) {
  var body = document.querySelector("body");
  var htmlMsg = "<div class= \"alertMsg login-".concat(status, "\"> <h1>").concat(msg, "</h1> </div>");
  body.insertAdjacentHTML('afterbegin', htmlMsg);
  setTimeout(function () {
    var el = document.querySelector('.alertMsg');
    el.style.display = 'none';
  }, 1500);
};

exports.alertMsg = alertMsg;
},{}],"modules/login.js":[function(require,module,exports) {
"use strict";
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (data.status === 'success') {
              (0, _alertMsg.alertMsg)('success', 'Successfuly Logged In');
          ...
          case 8:
            ...
            if (_context.t0.response.data.message) (0, _alertMsg.alertMsg)('fail', _context.t0.response.data.message);
            if (_context.t0.response.message) (0, _alertMsg.alertMsg)('fail', _context.t0.response.message);
...
},{"axios":"../../node_modules/axios/index.js","./alertMsg":"modules/alertMsg.js"}],"modules/profileSetting.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.profileSettingSave = void 0;
...
var profileSettingSave = /*#__PURE__*/function () {
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'Success' || res.data.status === 'success') {
              (0, _alertMsg.alertMsg)('success', 'Successfuly Setting Changed!');
              window.setTimeout(function () {
                location.reload();
              }, 1500);
            }
  ...
  return function profileSettingSave(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.profileSettingSave = profileSettingSave;
},{"axios":"../../node_modules/axios/index.js","./alertMsg":"modules/alertMsg.js"}],"modules/booking.js":[function(require,module,exports) {
"use strict";
...
var stripe = Stripe('pk_test_51L7dEZEaafq1Es3KVjGBwWiAY9Yip1WCw0g5MgEdFcwJAZkpLQ7q8GO3wSLf5oVIUxzcvXcf0fBAEl1vFMWIMqd200SQm1e1DR');
...
var book = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "http://127.0.0.1:3000/api/v1/bookings/check-out-session/".concat(id)
            });
  ...
  return function book(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.book = book;
},{"axios":"../../node_modules/axios/index.js","./alertMsg":"modules/alertMsg.js"}],"modules/opentab.js":[function(require,module,exports) {
"use strict";
...
function openTab() {
  ...
  tablinks.forEach(function (el, i) {
    el.addEventListener('click', function (e) {
      var target;
      if (e.target.className.includes("tablinks") || e.target.parentElement.className.includes('tablinks')) target = e.target.className.includes("tablinks") ? e.target.dataset.targets : e.target.parentElement.dataset.targets;
...
var _login = require("./modules/login.js");

var _profileSetting = require("./modules/profileSetting.js");

var _booking = require("./modules/booking.js");

var _opentab = require("./modules/opentab.js");
...
var updateProfile = function updateProfile() {
  var form = document.querySelector('.myaccountform');
  if (!form) return;
  form.addEventListener('submit', function (e) {
    e.preventDefault(); // const name = document.querySelector('.myaccountform__name').value
    ...
    console.log(form);
    (0, _profileSetting.profileSettingSave)(form, 'data');
  });
};

var bookingTour = function bookingTour() {
